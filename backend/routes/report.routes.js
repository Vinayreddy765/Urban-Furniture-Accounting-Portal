...
router.get('/balance-sheet',ctrl.balanceSheet); router.get('/profit-loss',ctrl.profitLoss); router.get('/budget',ctrl.budget); router.get('/trial-balance',ctrl.trialBalance);
